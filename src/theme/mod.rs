...
//! sixteen concrete [`Theme`] literals), and [`derive`] (the active-theme
...
pub use derive::{
    ...
    image_reveal_scrim, muted, overlay_selected_band, page_frame_ink, placard_ink,
    placard_stipple_density, primary, selection, set_active, set_active_by_name, surface_selected,
};
...
pub use model::{
    Backdrop, CardAnchor, CaretBlockStyle, DecorativeWash, Elevation, HighlightTexture,
    HighlightTreatment, ImageReveal, PageFrame, PlacardCorner, PlacardInk, RenderCaps,
...
#[allow(unused_imports)] // the sixteen named world consts: public API surface
