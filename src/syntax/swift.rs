//! Swift syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a Swift buffer renders
...
//!
//! TODO(lang): implement Swift highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for Swift source — see the module docs. STUB: returns no spans.
