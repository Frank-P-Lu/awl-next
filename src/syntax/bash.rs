//! Bash syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a Bash buffer renders
...
//!
//! TODO(lang): implement Bash highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for Bash source — see the module docs. STUB: returns no spans.
