//! Kotlin syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a Kotlin buffer renders
...
//!
//! TODO(lang): implement Kotlin highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for Kotlin source — see the module docs. STUB: returns no spans.
