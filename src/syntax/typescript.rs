//! TypeScript syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a TypeScript buffer renders
...
//!
//! TODO(lang): implement TypeScript highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for TypeScript source — see the module docs. STUB: returns no spans.
