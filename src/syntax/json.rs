//! JSON syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a JSON buffer renders
...
//!
//! TODO(lang): implement JSON highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for JSON source — see the module docs. STUB: returns no spans.
