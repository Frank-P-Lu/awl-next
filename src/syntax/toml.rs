//! TOML syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a TOML buffer renders
...
//!
//! TODO(lang): implement TOML highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for TOML source — see the module docs. STUB: returns no spans.
