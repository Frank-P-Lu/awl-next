//! C syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a C buffer renders
...
//!
//! TODO(lang): implement C highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for C source — see the module docs. STUB: returns no spans.
