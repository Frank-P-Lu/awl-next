//! PHP syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a PHP buffer renders
...
//!
//! TODO(lang): implement PHP highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for PHP source — see the module docs. STUB: returns no spans.
