//! JavaScript syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a JavaScript buffer renders
...
//!
//! TODO(lang): implement JavaScript highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for JavaScript source — see the module docs. STUB: returns no spans.
