//! YAML syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a YAML buffer renders
...
//!
//! TODO(lang): implement YAML highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for YAML source — see the module docs. STUB: returns no spans.
