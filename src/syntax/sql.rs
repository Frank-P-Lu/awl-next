//! SQL syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a SQL buffer renders
...
//!
//! TODO(lang): implement SQL highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for SQL source — see the module docs. STUB: returns no spans.
