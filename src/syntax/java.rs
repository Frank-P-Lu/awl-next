//! Java syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a Java buffer renders
...
//!
//! TODO(lang): implement Java highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for Java source — see the module docs. STUB: returns no spans.
