//! CSS syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a CSS buffer renders
...
//!
//! TODO(lang): implement CSS highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for CSS source — see the module docs. STUB: returns no spans.
