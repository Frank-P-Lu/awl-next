//! Go syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a Go buffer renders
...
//!
//! TODO(lang): implement Go highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for Go source — see the module docs. STUB: returns no spans.
