//! HTML syntax lexer — STUB.
//!
//! Not yet implemented: [`spans`] returns an empty list, so a HTML buffer renders
...
//!
//! TODO(lang): implement HTML highlighting (see rust.rs for the template).

use super::SynKind;
use std::ops::Range;

/// Syntax spans for HTML source — see the module docs. STUB: returns no spans.
