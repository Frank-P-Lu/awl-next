...
pub static COMMANDS: &[Command] = &[
    ...
    // `FinishBuffer`.)
    Command { name: "Finish file",       action: Action::FinishBuffer,    native: "",        emacs: ""        , native_only: true },
    ...
    Command { name: "Task list",         action: Action::ToggleTaskList,     native: "",      emacs: "" , native_only: false },
    ...
    Command { name: "Italic",            action: Action::Italic,             native: "",      emacs: "" , native_only: false },
    ...
    Command { name: "Settings…",         action: Action::OpenSettingsMenu, native: "",       emacs: ""        , native_only: false },
