...
2. **6c ordering-law expansion — test only.** 🟡 IN PROGRESS — codex, 2026-07-19, branch `codex/6c-ordering-law-expansion`. Generalize the preview/crossing/present-transaction ordering law into a no-wildcard sweep over arm, disarm, settle, teardown, and present transitions. Acceptance: adding a transition variant fails to compile until handled; suite green.
